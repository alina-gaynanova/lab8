...
public class ServerRunner extends Thread {
    ...
    private ExecutorService readService = Executors.newCachedThreadPool();
    ...
    private void setClientSocket() throws IOException {
        consolePrint.println("LoginPage " + clientSocket + " accepted");

        reader = new SocketReader(clientSocket, new JPanel(), new ResourceBundle() {
            @Override

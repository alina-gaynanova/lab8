...
public class SocketReader implements Scannable {
    ...
    public SocketReader(Socket clientSocket, JPanel panel, ResourceBundle resourceBundle) throws IOException {
    ...
    public int scanInt() throws IOException {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(panel, resourceBundle.getString("numb_err"));
            return scanInt();
        }
        return inputInteger;
    }
